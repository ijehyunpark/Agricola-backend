...
public class FirePlace extends DefaultMajorCard implements CookingAnytimeTrigger, BakeTrigger {
    ...
    @Builder
    public FirePlace(Long cardID, int bonusPoint, ResourceStruct[] ingredients, String name, String description, ResourceStruct[] resourcesToFoodAnytime, AnimalStruct[] animalsToFoodAnytime, int bakeEfficiency) {
